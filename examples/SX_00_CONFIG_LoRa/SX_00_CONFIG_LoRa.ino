 ...
 *  Port to ESP32 (SX1278) Heltec WiFi LoRa 32 board: by Agge Bitter
 */
...
#include "arduinoLoRa.h"
	...
	// for later port to standard ESP Wroom 32
#else
// Use only if Multiprotocol Radio Shield is used AGGE
...
void setup()
{
  ...
  // Power ON the module
	...
	// if Multiprotocol Radio Shield is used AGGE
  e = sx1272.ON();
