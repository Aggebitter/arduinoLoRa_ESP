 ...
 *****************************************************************************/
 // Added by Agge for use with Heltec_WIFI_LoRa_32, using HW-SPI
...
//FREQUENCY CHANNELS:
// ETSI 433.175 MHz, 433.375 MHz and 433.575 MHz frequency channels.
const uint32_t CH_00_433 = 0x6C4B33; // channel 00, central freq = 433.175 MHz
const uint32_t CH_01_433 = 0x6C5800; // channel 01, central freq = 433.375 MHz
const uint32_t CH_02_433 = 0x6C64CC; // channel 02, central freq = 433.575 MHz
